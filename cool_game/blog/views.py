...
def ping(request):
    return render(request, 'blog/ping.html', {'title': 'ping'})
...
def index(request):
    return render(request, 'blog/index.html', {'title': ' SLASH HERO'})


def shoot(request):
    return render(request, 'blog/shoot.html', {'title': ' SHOOT THEM'})


def pong(request):
    return render(request, 'blog/pong.html', {'title': ' PING PONG'})


def Shape(request):
    return render(request, 'blog/Shape.html', {'title': ' 3D SHAPE RUNNER'})


def bird(request):
    return render(request, 'blog/bird.html', {'title': ' MAD BIRD'})
